...
python main_experiments.py --task_type similarity --models angle-base --epochs 0 --batch 0 --kfold 0 --optim adam --nhid 0 --initial_layer 0 --poolings all --agg_layers ALL
